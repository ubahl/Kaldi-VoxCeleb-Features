...
if [ $stage -le 1 ]; then
        # Make Spectrogram Feats.
        compute-spectrogram-feats scp:data/voxceleb1_test/wav.scp ark:feats/spect_test.ark
        copy-feats ark:feats/spect_test.ark ark,scp:feats/test/feats.ark,feats/test/feats.scp
        compute-spectrogram-feats scp:data/train/wav.scp ark:feats/spect_train.ark
        copy-feats ark:feats/spect_train.ark ark,scp:data/train/feats.ark,data/train/feats.scp
...
if [ $stage -le 5 ]; then
  ...
  utils/filter_scp.pl data/train_no_sil/utt2spk data/trail_no_sil/utt2num_frames > data/train_no_sil/utt2num_frames.new
